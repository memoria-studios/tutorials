namespace FormDataExchange
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            SettingsForm.DataChanged += OnSettingsDataChanged;
        ...
        private void buttonConfirm_Click(object sender, EventArgs e)
        {
            ...
            DataChanged?.Invoke(m_dataPackage); // We trigger the event with our data package, so whoever is listening to our event will get our newly updated data package
